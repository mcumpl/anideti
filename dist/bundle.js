...
exports.scrollAndClose = scrollAndClose;
...
var _photoswipeUiDefault = __webpack_require__(1);
...
function scrollTo(event, selector) {
    ...
    (0, _jquery2.default)('html, body').animate({
        scrollTop: (0, _jquery2.default)(selector).offset().top
    }, 1500);
}

function toggleMenu(event) {
    event.preventDefault();
    (0, _jquery2.default)("#sidebar-wrapper").toggleClass("active");
}
